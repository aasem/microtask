...
const TaskCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start gap-4">
        <div className="flex-1">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-[25px] font-semibold text-gray-900 leading-tight">
              {task.title}
            </h3>
            {isOverdue && (
      ...
      {/* Task Description */}
      {task.description && (
        <p className="text-sm text-gray-600 mt-1.5 mb-3 line-clamp-2">
          {task.description}
        </p>
      )}

      {/* Metadata Grid */}
      <div className="grid grid-cols-3 gap-x-4 gap-y-2 mt-3 text-sm text-gray-600">
        {/* Assignment */}
